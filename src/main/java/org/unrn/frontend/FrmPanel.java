...
public class FrmPanel extends JFrame {
    ...
    private void iniciarComponentes() {
        lbl = ResourceBundle.getBundle("lang/lbl", new Locale("es"));
    ...
    private void ubicarPaneles() {
        ...
        setTitle(lbl.getString("menu.Titulo"));
        setExtendedState(0);
        agregarTabPanel();
        pack();
    }
    ...
    private void agregarTabDuenio() {
        jPanel1.setBorder(BorderFactory.createTitledBorder(null, lbl.getString("tabDuenio.Titulo"), 0, 0, fntTitulo));
        jLabel1.setIcon(imgVivienda);
        jLabel2.setIcon(imgRecolectores);
        jLabel3.setIcon(imgPedidos);
        jLabel4.setFont(fntLabel);
        jLabel4.setText(lbl.getString("tabDuenio.Nombre"));
        jLabel5.setFont(fntLabel);
        jLabel5.setText(lbl.getString("tabDuenio.Apellido"));
        jLabel6.setFont(fntLabel);
        jLabel6.setText(lbl.getString("tabDuenio.Documento"));
        jLabel7.setFont(fntLabel);
        jLabel7.setText(lbl.getString("tabDuenio.Correo"));
        jLabel8.setFont(fntLabel);
        jLabel8.setText(lbl.getString("tabDuenio.Telefono"));
        btnRegDuenio.setIcon(icoModificar);
        btnRegDuenio.setText(lbl.getString("tabDuenio.RegistrarDuenio"));
        ...
        jTabbedPane1.addTab(lbl.getString("tabDuenio.Rotulo"), jPanel2);
    }
